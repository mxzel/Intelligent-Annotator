...
def create_project(request):
    if request.method == 'POST':
        ...
        return HttpResponse(manager.create_project(project_name=projectname, project_tags=[]))
...
def upload_file(request):
    if request.method == "POST":
        ...
        return HttpResponse(
            manager.upload_file(file_name=file_name, project_id=project_id, file_contents=file_contents))
...
def fetch_unlabeled_data(request):
    if request.method == "POST":
        ...
        return HttpResponse(manager.fetch_unlabeled_data(project_id=projectid, num=num))
...
def commit_label_data(request):
    if request.method == "POST":
        ...
        return HttpResponse(manager.commit_labeled_data(
...
def export_project(request):
    if request.method == "POST":
        ...
        return HttpResponse(manager.export_project(project_id=projectid))
